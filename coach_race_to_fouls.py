...
while i<len(df):
    ...
    if ((split_1[2]== "18") or ((split_1[2]== "19") and (int(split_1[0]) <=4))):
        ...
        if away_cg[0]!="":
            if away_cg[1]== "B":
                b_coach_foul_89.append(away_fc)
                gamecount+=1
                print(away_fc)
            elif away_cg[1]=="W":
                w_coach_foul_89.append(away_fc)
                gamecount+=1
                print(away_fc)
        
        if home_cg[0]!="":
            if home_cg[1]== "B":
                b_coach_foul_89.append(home_fc)
                gamecount+=1
                print(home_fc)
            elif home_cg[1]=="W":
                w_coach_foul_89.append(home_fc)
                gamecount+=1
                print(home_fc)
            ...
            if away_cg[0]!="":
                if away_cg[1]== "B":
                    b_coach_foul_90.append(away_fc)
                    gamecount+=1
                    print(away_fc)
                elif away_cg[1]=="W":
                    w_coach_foul_90.append(away_fc)
                    gamecount+=1
                    print(away_fc)
            
            if home_cg[0]!="":
                if home_cg[1]== "B":
                    b_coach_foul_90.append(home_fc)
                    gamecount+=1
                    print(home_fc)
                elif home_cg[1]=="W":
                    w_coach_foul_90.append(home_fc)
                    gamecount+=1
                    print(home_fc)
            ...
            if away_cg[0]!="":
                if away_cg[1]== "B":
                    b_coach_foul_01.append(away_fc)
                    gamecount+=1
                    print(away_fc)
                elif away_cg[1]=="W":
                    w_coach_foul_01.append(away_fc)
                    gamecount+=1
                    print(away_fc)
            
            if home_cg[0]!="":
                if home_cg[1]== "B":
                    b_coach_foul_01.append(home_fc)
                    gamecount+=1
                    print(home_fc)
                elif home_cg[1]=="W":
                    w_coach_foul_01.append(home_fc)
                    gamecount+=1
                    print(home_fc)
            ...
            if away_cg[0]!="":
                if away_cg[1]== "B":
                    b_coach_foul_12.append(away_fc)
                    gamecount+=1
                    print(away_fc)
                elif away_cg[1]=="W":
                    w_coach_foul_12.append(away_fc)
                    gamecount+=1
                    print(away_fc)
            
            if home_cg[0]!="":
                if home_cg[1]== "B":
                    b_coach_foul_12.append(home_fc)
                    gamecount+=1
                    print(home_fc)
                elif home_cg[1]=="W":
                    w_coach_foul_12.append(home_fc)
                    gamecount+=1
                    print(home_fc)
            ...
            if away_cg[0]!="":
                if away_cg[1]== "B":
                    b_coach_foul_23.append(away_fc)
                    gamecount+=1
                    print(away_fc)
                elif away_cg[1]=="W":
                    w_coach_foul_23.append(away_fc)
                    gamecount+=1
                    print(away_fc)
            
            if home_cg[0]!="":
                if home_cg[1]== "B":
                    b_coach_foul_23.append(home_fc)
                    gamecount+=1
                    print(home_fc)
                elif home_cg[1]=="W":
                    w_coach_foul_23.append(home_fc)
                    gamecount+=1
                    print(home_fc)
...
print("2018-19")
print(b_coach_foul_89)
print(w_coach_foul_89)
result1= f_oneway(b_coach_foul_89, w_coach_foul_89)
result2= alexandergovern(b_coach_foul_89,w_coach_foul_89)
print(result1)
print(result2)
...
print("2019-20")
print(b_coach_foul_90)
print(w_coach_foul_90)
result3= f_oneway(b_coach_foul_90, w_coach_foul_90)
result4= alexandergovern(b_coach_foul_90,w_coach_foul_90)
print(result3)
print(result4)
...
print("2020-21")
print(b_coach_foul_01)
print(w_coach_foul_01)
result5= f_oneway(b_coach_foul_01, w_coach_foul_01)
result6= alexandergovern(b_coach_foul_01,w_coach_foul_01)
print(result5)
print(result6)
...
print("2021-22")
print(b_coach_foul_12)
print(w_coach_foul_12)
result7= f_oneway(b_coach_foul_01, w_coach_foul_12)
result8= alexandergovern(b_coach_foul_01,w_coach_foul_12)
print(result7)
print(result8)
...
print("2022-23")
print(b_coach_foul_23)
print(w_coach_foul_23)
result9= f_oneway(b_coach_foul_01, w_coach_foul_23)
result10= alexandergovern(b_coach_foul_01,w_coach_foul_23)
print(result9)
print(result10)
